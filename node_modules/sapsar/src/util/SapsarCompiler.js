    ...
    if (!cache.pages[page]) {
        ...
        if (staticPage){
            ...
            try {
                ...
                return SapsarErrorPage(`Error while rendering <b>${page}</b>`, err.name, err.message, stack)
            }
...
async function SapsarUnknownPageHandler(page){
    if (cache['404']){
        ...
        return SapsarErrorPage(
            ...
            "Error 404",
            "Page not found",
            "Try re-checking your app's page files, and seeing if the one you're looking for exists."
        )
    }
}
